...
describe( 'deepset cdf', function tests() {
	...
	it( 'should compute the Erlang cdf and deep set', function test() {
		var data, expected, i;
	...
	it( 'should return an empty array if provided an empty array', function test() {
		assert.deepEqual( cdf( [], k, lambda, 'x' ), [] );
		assert.deepEqual( cdf( [], k, lambda, 'x', '/' ), [] );
	});
