...
describe( 'distributions-erlang-cdf', function tests() {
	...
	it( 'should compute the Erlang cdf when provided a number', function test() {
	...
	it( 'should evaluate the Erlang cdf when provided a plain array', function test() {
	...
	it( 'should evaluate the Erlang cdf when provided a typed array', function test() {
	...
	it( 'should evaluate the Erlang cdf element-wise and return an array of a specific type', function test() {
	...
	it( 'should evaluate the Erlang cdf element-wise using an accessor', function test() {
	...
	it( 'should evaluate the Erlang cdf element-wise and deep set', function test() {
	...
	it( 'should evaluate the Erlang cdf element-wise when provided a matrix', function test() {
	...
	it( 'should evaluate the Erlang cdf element-wise and return a matrix of a specific type', function test() {
		var validationData = require( './fixtures/matrix.json' ),
			mat,
			out,
			d1,
